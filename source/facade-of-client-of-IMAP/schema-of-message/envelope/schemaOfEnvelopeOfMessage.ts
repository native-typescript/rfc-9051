	...
	.strictObject({
		bcc: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(bcc: undefined): null {
					return null;
				}),
		]),
		cc: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(cc: undefined): null {
					return null;
				}),
		]),
		date: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(date: undefined): null {
					return null;
				}),
		]),
		...
		inReplyTo: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(inReplyTo: undefined): null {
					return null;
				}),
		]),
		messageId: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(messageId: undefined): null {
					return null;
				}),
		]),
		replyTo: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNNull(replyTo: undefined): null {
					return null;
				}),
		]),
		sender: z
		...
		subject: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(subject: undefined): null {
					return null;
				}),
		]),
		to: z.union([
			...
			z
				.undefined()
				.optional()
				.transform<null>(function makeNull(addressList: undefined): null {
					return null;
				}),
		]),
	})
