import {LeafNonRootNodeOfBodystructureOfMessage} from "../../../../../../message/index.ts";
import {z} from "zod";
export const schemaOfLeafNonRootNodeOfBodystructureOfMessage: z.ZodType<LeafNonRootNodeOfBodystructureOfMessage> =
	z
		.union([
			z.strictObject({
				description: z.union([
		...
		.transform<LeafNonRootNodeOfBodystructureOfMessage>(
			function parseLeafNonRootNode(
				node,
			): LeafNonRootNodeOfBodystructureOfMessage {
				if (node.disposition === null) {
					const parsedNode: LeafNonRootNodeOfBodystructureOfMessage =
						new LeafNonRootNodeOfBodystructureOfMessage(
							...
							node.encoding,
							{
								parameters: {
									name:
										node.parameters === null ? null : node.parameters[`name`],
								},
								value: node.type,
							},
						);
