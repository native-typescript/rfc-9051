import {TextPlainRootNodeOfBodystructureOfMessage} from "../../../../../../message/index.ts";
import {z} from "zod";
export const schemaOfTextPlainRootNodeOfBodystructureOfMessage: z.ZodType<TextPlainRootNodeOfBodystructureOfMessage> =
	z
		.union([
			z.strictObject({
				description: z.union([
		...
		.transform<TextPlainRootNodeOfBodystructureOfMessage>(
			function parseTextPlainRootNode(node) {
				if (node.disposition === null) {
					const parsedNode: TextPlainRootNodeOfBodystructureOfMessage =
