import {TextNonPlainNonRootNodeOfBodystructureOfMessage} from "../../../../../../message/index.ts";
import {z} from "zod";
export const schemaOfTextNonPlainNonRootNodeOfBodystructureOfMessage: z.ZodType<TextNonPlainNonRootNodeOfBodystructureOfMessage> =
	z
		.union([
			z.strictObject({
				description: z.union([
				...
				type: z.union([z.literal(`text/html`), z.literal(`text/xml`)]),
			}),
			z.strictObject({
				description: z.union([
					z.string().nonempty(),
		...
		.transform<TextNonPlainNonRootNodeOfBodystructureOfMessage>(
			function parseTextNonPlainNonRootNode(node) {
				if (node.disposition === null) {
					const parsedNode: TextNonPlainNonRootNodeOfBodystructureOfMessage =
