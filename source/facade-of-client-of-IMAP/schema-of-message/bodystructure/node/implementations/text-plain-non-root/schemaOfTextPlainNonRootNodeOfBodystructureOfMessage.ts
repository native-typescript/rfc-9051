import {TextPlainNonRootNodeOfBodystructureOfMessage} from "../../../../../../message/index.ts";
import {z} from "zod";
export const schemaOfTextPlainNonRootNodeOfBodystructureOfMessage: z.ZodType<TextPlainNonRootNodeOfBodystructureOfMessage> =
	z
		.union([
			z.strictObject({
				description: z.union([
					...
					z
						.undefined()
						.optional()
						.transform<null>(function makeNull(description: undefined): null {
							return null;
						}),
				]),
				disposition: z
					.undefined()
					.optional()
					.transform<null>(function makeNull(
						disposition: undefined,
						context,
					): null {
						return null;
					}),
				dispositionParameters: z.undefined().optional(),
				encoding: z.union([
					z.literal(`7bit`),
					z.literal(`8bit`),
					z.literal(`base64`),
				...
				id: z.union([
					...
					z
						.undefined()
						.optional()
						.transform<null>(function makeNull(id: undefined): null {
							return null;
						}),
				]),
				lineCount: z.union([
					...
					z
						.undefined()
						.optional()
						.transform<null>(function makeNull(lineCount: undefined): null {
							return null;
						}),
				]),
				parameters: z.strictObject({
					charset: z.union([
						...
						z
							.undefined()
							.optional()
							.transform<null>(function makeNull(charset: undefined): null {
								return null;
							}),
					]),
					format: z.union([
						...
						z
							.undefined()
							.optional()
							.transform(function makeNull(format: undefined): null {
								return null;
							}),
					]),
					name: z.union([
						...
						z
							.undefined()
							.optional()
							.transform<null>(function makeNull(name: undefined): null {
								return null;
							}),
					]),
				}),
		...
		.transform<TextPlainNonRootNodeOfBodystructureOfMessage>(
			function parseTextPlainNonRootNode(node) {
				if (node.disposition === null) {
					const parsedNode: TextPlainNonRootNodeOfBodystructureOfMessage =
