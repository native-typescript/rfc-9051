import {TextNonPlainRootNodeOfBodystructureOfMessage} from "../../../../../../message/index.ts";
import {z} from "zod";
export const schemaOfTextNonPlainRootNodeOfBodystructureOfMessage: z.ZodType<TextNonPlainRootNodeOfBodystructureOfMessage> =
	z
		.union([
			z.strictObject({
				description: z.union([
		...
		.transform<TextNonPlainRootNodeOfBodystructureOfMessage>(
			function parseTextNonPlainRootNode(node) {
				if (node.disposition === null) {
					const parsedNode: TextNonPlainRootNodeOfBodystructureOfMessage =
