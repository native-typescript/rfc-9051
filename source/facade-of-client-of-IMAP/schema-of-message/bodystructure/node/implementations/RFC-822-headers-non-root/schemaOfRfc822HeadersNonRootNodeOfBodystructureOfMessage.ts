import {Rfc822HeadersNonRootNodeOfBodystructureOfMessage} from "../../../../../../message/index.ts";
import {z} from "zod";
export const schemaOfRfc822HeadersNonRootNodeOfBodystructureOfMessage: z.ZodType<Rfc822HeadersNonRootNodeOfBodystructureOfMessage> =
	z
		.union([
			z.strictObject({
				description: z.union([
		...
		.transform<Rfc822HeadersNonRootNodeOfBodystructureOfMessage>(
			function parseRfc822HeadersNonRootNode(node) {
				if (node.disposition === null) {
					const parsedNode: Rfc822HeadersNonRootNodeOfBodystructureOfMessage =
						new Rfc822HeadersNonRootNodeOfBodystructureOfMessage(
							node.description,
							null,
							node.encoding,
							{
